...
directory = '/home/su.direkci/glitch_project/dataset_no_glitch_no_noise/'
path_to_glitschen = '/home/su.direkci/programs/glitschen'

training_wg = wd.WaveformGenerator(dataset_len=1000, add_glitch=False, add_noise=False,
...
# validation data
validation_wg = wd.WaveformGenerator(dataset_len=100, add_glitch=False, add_noise=False,
                                     directory=directory, path_to_glitschen=path_to_glitschen)
...
testing_wg = wd.WaveformGenerator(dataset_len=100, add_glitch=False, add_noise=False,
                                  directory=directory, path_to_glitschen=path_to_glitschen)
