...
training_wg = wd.WaveformGenerator(dataset_len=512, add_glitch=False, add_noise=True,
                                   directory=directory, path_to_glitschen=path_to_glitschen, svd_no_basis_coeffs=20)
