...
directory = '/home/su.direkci/glitch_project/dataset_w_glitch_3p_svd_10_1m/'
path_to_glitschen = '/home/su.direkci/programs/glitschen'

training_wg = wd.WaveformGenerator(dataset_len=1000000, add_glitch=True, add_noise=True,
...
# validation data
validation_wg = wd.WaveformGenerator(dataset_len=100000, add_glitch=True, add_noise=True,
                                     directory=directory, path_to_glitschen=path_to_glitschen,
                                     svd_no_basis_coeffs=10)
...
testing_wg = wd.WaveformGenerator(dataset_len=100000, add_glitch=True, add_noise=True,
                                  directory=directory, path_to_glitschen=path_to_glitschen,
                                  svd_no_basis_coeffs=10)
