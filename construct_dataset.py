...
directory = '/home/su.direkci/glitch_project/small_dataset_no_glitch_w_noise_10k/'
path_to_glitschen = '/home/su.direkci/programs/glitschen'

training_wg = wd.WaveformGenerator(dataset_len=10000, add_glitch=False, add_noise=True,
...
# validation data
validation_wg = wd.WaveformGenerator(dataset_len=1000, add_glitch=False, add_noise=True,
                                     directory=directory, path_to_glitschen=path_to_glitschen, svd_no_basis_coeffs=100)
...
testing_wg = wd.WaveformGenerator(dataset_len=1000, add_glitch=False, add_noise=True,
                                  directory=directory, path_to_glitschen=path_to_glitschen, svd_no_basis_coeffs=100)
